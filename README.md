...
魔改 OpenAI 官方 repo <https://github.com/openai/openai-realtime-console>

![image](https://github.com/user-attachments/assets/f187f29e-b2a3-48ca-a7e7-54f371a51139)



* 輸入文字可以有音頻對話。
* 可以自訂修改 System Prompt 
